...
class EditStaff extends Component {
    ...
    render() {
        return (
            <div>
                <div>
                    <Button type="button" className="btn btn-warning" onClick={this.toggleModal}>Edit</Button>
                </div>
                <div>
                    <Modal isOpen={this.state.isOpenModal} toggle={this.toggleModal}>
                        <ModalHeader toggle={this.toggleForm}>Đổi thông tin nhân viên</ModalHeader>
